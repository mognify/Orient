...
public class MouseController {
	...
	protected static void click(int x, int y, int delayMS) throws AWTException, InterruptedException {
		//q.add(new Thread() {
			//public void run() {
	...
	protected static void drag(int x1, int y1, int x2, int y2, int delayMS) throws AWTException, InterruptedException {
		Robot bot = new Robot(MouseInfo.getPointerInfo().getDevice());
